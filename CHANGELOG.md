...
- apply updated ameba linting changes

### Docs

- **readme**: clarify parsing and emission behaviors, plus a few typos
- **readme**: minor wordsmithing and typo fixes

### Build System

- update to crystal 1.21 and ameba 1.7.0-dev
- **gitignore**: Ignore autogenerated lattice LSP cache files

### CI

- **gha**: update gha to crystal 1.21.0 and improve caching
